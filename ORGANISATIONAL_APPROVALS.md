...
The remaining decisions are narrower than the earlier wording suggested. They are organisation approval for staged regional page publication; any final review of the 328-record historical register; an approved transactional email provider and sender identity; authorised area-admin and national-admin accounts for real role-boundary acceptance; and native touch-device keyboard acceptance. The earlier HTML-page crawl throttle is no longer a blocker: the live WordPress REST API returned and body-inventoried 100 public pages, posts, events, venues, and organizers across all five sites; all 100 have a migration-register outcome, and every sitemap URL is classified alongside canonical current TSML meeting/location coverage. The current build, finder, maps, area routes, online/in-person separation, emergency path, hero assets, tests, and production build are not awaiting technical completion.
