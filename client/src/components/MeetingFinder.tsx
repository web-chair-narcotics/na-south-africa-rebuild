    ...
    <div className="site-container py-8 sm:py-12">
      <section className="rounded-3xl border border-[#d7dfd5] bg-white p-5 shadow-[0_12px_32px_rgba(20,45,42,0.05)] sm:p-7">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end">
          <label className="block flex-1"><span className="mb-2 block text-sm font-bold text-[#28383d]">Search meetings</span><div className="relative"><Search className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#2e6756]" /><input value={filters.query} onChange={event => update("query", event.target.value)} placeholder="Area, suburb, meeting or venue" className="h-12 w-full rounded-xl border border-[#bfcac0] bg-white pl-11 pr-4 text-base outline-none placeholder:text-[#77867d] focus:border-[#145044] focus:ring-2 focus:ring-[#145044]/20" /></div></label>
